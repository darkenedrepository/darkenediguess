...
local FirstButton = FirstPage.AddButton("Dex V4", function()
 loadstring(game:HttpGet('https://raw.githubusercontent.com/DarkenedBreeze/darkeneds-exploit-things/main/dex%20v4%20thing'))()
end)
